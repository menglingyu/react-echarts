...
var Bar = function (_BaseModule) {
  _inherits(Bar, _BaseModule);
  ...
  function Bar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Bar.__proto__ || Object.getPrototypeOf(Bar)).call.apply(_ref, [this].concat(args))), _this), _this.baseOption = {
      title: {
        text: '$堆叠区域图'
      },
      tooltip: {
  ...
  _createClass(Bar, [{
    ...
    value: function processOption(option) {
      ...
      option.series = this.processData('scatter');
      return option;
    }
  }]);
